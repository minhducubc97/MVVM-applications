...
- *DetectPorts*: An WPF application that can detect all the COM ports and USB available in the system. It will also notify the user when a COM port is inserted/removed.
